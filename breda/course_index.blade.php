        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 mb-md-30 mb-xs-30">
                <div class="feature-content-2">
                    ...
                    <h3 class="title">Cursussen en Workshops in Breda</h3>
                    <p>
        ...
        <div class="row mb-35">
            <div class="col-xl-12">
                <div class="filter-tags text-center">
                    ...
                    <a href="{{ str_replace($type->type, '', request()->fullUrl()) }}" class="active">
                    ...
                    <div class="filter-select">
                        <div class="select-wrap">
                            <select class="nice-select" data-js-placeholder="CATEGORIE" name="cat[]" multiple="true" onchange="this.form.submit()">
                                ...
                                <option value="{{ $category->id }}"
                                    @if(in_array($category->id, (array)request()->get('cat') ?? [])) selected @endif>
                        ...
                        <div class="select-wrap">
                            <select class="nice-select" name="startday[]" multiple="true" onchange="this.form.submit()" data-js-placeholder="STARTDAG">
                                ...
                                <option value="1"
                                @if(in_array('1', (array)request()->get('startday') ?? [])) selected @endif>
                                    Maandag
                                </option>
                                
                                <option value="2"
                                @if(in_array('2', (array)request()->get('startday') ?? [])) selected @endif>
                                    Dinsdag
                                </option>
                                
                                <option value="3"
                                @if(in_array('3', (array)request()->get('startday') ?? [])) selected @endif>
                                    Woensdag
                                </option>

                                <option value="4"
                                @if(in_array('4', (array)request()->get('startday') ?? [])) selected @endif>
                                    Donderdag
                                </option>

                                <option value="5"
                                @if(in_array('5', (array)request()->get('startday') ?? [])) selected @endif>
                                    Vrijdag
                                </option>

                                <option value="6" 
                                @if(in_array('6', (array)request()->get('startday') ?? [])) selected @endif>
                                    Zaterdag
                                </option>

                                <option value="7"
                                @if(in_array('7', (array)request()->get('startday') ?? [])) selected @endif>
                                    Zondag
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="select-wrap sorting-select float-none float-xl-end">
                            <select class="nice-select" name="sort" onchange="this.form.submit()" data-js-placeholder="SORTEER OP">
                                <option value="price"
                                    @if(in_array('price', (array)request()->get('sort') ?? [])) selected @endif
                                >
                                    Prijs
                                </option>
                                <option value="created_at"
                                    @if(in_array('created_at', (array)request()->get('sort') ?? [])) selected @endif    
                                >
                                    Nieuw
                                </option>
                            </select>
